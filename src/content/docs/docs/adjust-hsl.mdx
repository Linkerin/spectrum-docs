...
The `adjustHsl` function allows you to adjust the HSL (Hue, Saturation,
Lightness) values of a color object. This function returns a new `Spectrum`
...
const adjustedColor = adjustHsl(color, {
  ...
  lightness: '-5%' // Decrease lightness by 5%
});
...
The `adjustHsl` function returns a new [`Spectrum`](/docs/spectrum-class)
